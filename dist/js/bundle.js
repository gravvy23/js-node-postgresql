...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nvar _calendarView = __webpack_require__(/*! ../views/calendarView */ \"./src/js/views/calendarView.js\");\n\nvar calendarView = _interopRequireWildcard(_calendarView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar url = \"https://server-bd.eu-gb.mybluemix.net\";\n\nvar Calendar = function () {\n    function Calendar(month, year) {\n        _classCallCheck(this, Calendar);\n\n        switch (month) {\n            case 1:\n            case 3:\n            case 5:\n            case 7:\n            case 8:\n            case 10:\n            case 12:\n                this.monthLenght = 31;\n                break;\n            case 2:\n                this.monthLenght = 28;\n                break;\n            default:\n                this.monthLenght = 30;\n        }\n        this.days = [];\n        this.month = month;\n        this.year = year;\n    }\n\n    _createClass(Calendar, [{\n        key: 'searchResults',\n        value: function searchResults(route) {\n            var _this = this;\n\n            fetch(url + '/routes/' + route + '?month=' + this.month).then(function (res) {\n                return res.json();\n            }).then(function (res) {\n                res.forEach(function (element) {\n                    var day = element.data.split('-', 3)[2].split('T')[0];\n                    day = parseInt(day);\n                    _this.days.push({\n                        dayOfMonth: day,\n                        price: element.cena_minimalna,\n                        flight: element.lot\n                    });\n                }), calendarView.showCallendar(new Date(_this.year, _this.month - 1, 1).getDay(), _this.days, _this.month, _this.monthLenght);\n            }).catch(function (error) {\n                return console.log(error);\n            });\n        }\n    }]);\n\n    return Calendar;\n}();\n\nexports.default = Calendar;\n\n//# sourceURL=webpack:///./src/js/models/Calendar.js?");

/***/ }),

/***/ "./src/js/models/Flights.js":
/*!**********************************!*\
  !*** ./src/js/models/Flights.js ***!
  \**********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nvar _flightsView = __webpack_require__(/*! ../views/flightsView */ \"./src/js/views/flightsView.js\");\n\nvar view = _interopRequireWildcard(_flightsView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar url = \"https://server-bd.eu-gb.mybluemix.net\";\n\nvar Flights = function () {\n    function Flights() {\n        _classCallCheck(this, Flights);\n\n        this.flightId = null;\n        this.allFlightsData = null;\n    }\n\n    _createClass(Flights, [{\n        key: 'addFlight',\n        value: function addFlight(flight) {\n            this.flightId = flight;\n        }\n    }, {\n        key: 'addFlights',\n        value: function addFlights(data) {\n            this.allFlightsData = data;\n        }\n    }, {\n        key: 'getFlightInfo',\n        value: function getFlightInfo(worker) {\n            var _this = this;\n\n            fetch(url + '/staff/' + worker + '/flights/' + this.flightId).then(function (res) {\n                return res.json();\n            }).then(function (res) {\n                var flight = _this.allFlightsData.find(function (element) {\n                    return element.rejs == _this.flightId;\n                });\n                view.showDetails(res[0], flight);\n            }).catch(function (error) {\n                return console.log(error);\n            });\n        }\n    }, {\n        key: 'getCrew',\n        value: function getCrew() {\n            fetch(url + '/flights/' + this.flightId + '/staff').then(function (res) {\n                return res.json();\n            }).then(function (res) {\n                view.showCrew(res);\n            }).catch(function (error) {\n                return console.log(error);\n            });\n        }\n    }, {\n        key: 'clearData',\n        value: function clearData() {\n            this.flightId = null;\n            this.allFlightsData = null;\n        }\n    }]);\n\n    return Flights;\n}();\n\nexports.default = Flights;\n\n//# sourceURL=webpack:///./src/js/models/Flights.js?");

/***/ }),

/***/ "./src/js/models/Reservations.js":
/*!***************************************!*\
  !*** ./src/js/models/Reservations.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nvar _reservationsView = __webpack_require__(/*! ../views/reservationsView */ \"./src/js/views/reservationsView.js\");\n\nvar view = _interopRequireWildcard(_reservationsView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar url = \"https://server-bd.eu-gb.mybluemix.net\";\n\nvar Reservations = function () {\n    function Reservations() {\n        _classCallCheck(this, Reservations);\n\n        this.flightId = null;\n        this.luggageId = null;\n        this.placeId = null;\n        this.luggage = null;\n    }\n\n    _createClass(Reservations, [{\n        key: 'addFlight',\n        value: function addFlight(flightid) {\n            this.flightId = flightid;\n        }\n    }, {\n        key: 'addPlace',\n        value: function addPlace(target) {\n            var place = target.closest('.reservation-info__luggage').previousSibling.previousSibling.children[2].innerHTML;\n            this.placeId = parseInt(place);\n            this.luggage = target.previousSibling.previousSibling;\n        }\n    }, {\n        key: 'getReservationInfo',\n        value: function getReservationInfo(userId) {\n            var _this = this;\n\n            fetch(url + '/users/' + userId + '/flights/' + this.flightId).then(function (res) {\n                return res.json();\n            }).then(function (res) {\n                view.showDetails(res, _this.flightId);\n            }).catch(function (error) {\n                return console.log(error);\n            });\n        }\n    }, {\n        key: 'deleteReservation',\n        value: function deleteReservation(userId) {\n            var _this2 = this;\n\n            fetch(url + '/users/' + userId + '/flights/' + this.flightId, {\n                method: 'delete'\n            }).then(function (response) {\n                return response.json();\n            }).then(function (res) {\n                _this2.flightId = null;\n                _this2.placeId = null;\n                _this2.luggageId = null;\n                view.closeReservationInfo();\n            }).then(function (res) {\n                _base.elements.navigationButtonMyFlights.click();\n            }).catch(function (error) {\n                return console.log(error);\n            });\n        }\n    }, {\n        key: 'submitLuggage',\n        value: function submitLuggage(userId) {\n            var _this3 = this;\n\n            var data = {\n                miejsce: this.placeId,\n                typ: this.luggageId\n            };\n            fetch(url + '/users/' + userId + '/flights/' + this.flightId, {\n                method: 'POST',\n                body: JSON.stringify(data),\n                headers: {\n                    'Content-Type': 'application/json'\n                }\n            }).then(function (res) {\n                return res.json();\n            }).then(function (res) {\n                if (res.status != 'OK') {\n                    alert(\"Błąd połączenia z serwerem :( spróbuj poźniej\");\n                } else {\n                    _this3.luggage.innerHTML = parseInt(_this3.luggage.innerHTML) + 1;\n                }\n                _this3.placeId = null;\n                _this3.luggageId = null;\n                _this3.luggage = null;\n            }).catch(function (error) {\n                return console.log(error);\n            });\n        }\n    }, {\n        key: 'clearData',\n        value: function clearData() {\n            this.flightId = null;\n            this.luggageId = null;\n            this.placeId = null;\n            this.luggage = null;\n        }\n    }]);\n\n    return Reservations;\n}();\n\nexports.default = Reservations;\n\n//# sourceURL=webpack:///./src/js/models/Reservations.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar url = \"https://server-bd.eu-gb.mybluemix.net\";\n\nvar Search = function () {\n    function Search() {\n        _classCallCheck(this, Search);\n\n        this.userId = null;\n        this.workerId = null;\n        this.flightSearch = {\n            origin: null,\n            destination: null,\n            route: null,\n            month: null,\n            year: null,\n            numberOfPeople: null\n        };\n        this.date = {\n            flight: null,\n            minPrice: null\n        };\n        this.reservation = null;\n    }\n\n    _createClass(Search, [{\n        key: 'addOrigin',\n        value: function addOrigin(airport) {\n            var city = airport.querySelector('.flight-search__panel__toggler__origins__element_name').innerText;\n            var abbr = airport.querySelector('.flight-search__panel__toggler__origins__element_abrr').innerText;\n            _base.elements.listPanelOrigin.value = city + ' (' + abbr + ')';\n            _base.elements.listPanelDestination.value = '';\n            this.flightSearch.origin = abbr;\n            this.flightSearch.destination = null;\n        }\n    }, {\n        key: 'addDestination',\n        value: function addDestination(airport) {\n            var city = airport.querySelector('.flight-search__panel__toggler__destinations__element_name').innerText;\n            var abbr = airport.querySelector('.flight-search__panel__toggler__destinations__element_abrr').innerText;\n            _base.elements.listPanelDestination.value = city + ' (' + abbr + ')';\n            this.flightSearch.destination = abbr;\n            this.flightSearch.route = parseInt(airport.dataset.goto);\n        }\n    }, {\n        key: 'checkForm',\n        value: function checkForm() {\n            if (!this.flightSearch.origin) {\n                _base.elements.originListButton.click();\n                return false;\n            } else if (!this.flightSearch.destination) {\n                _base.elements.destinationListButton.click();\n                return false;\n            } else {\n                this.flightSearch.month = parseInt(_base.elements.monthSearchList.value);\n                this.flightSearch.year = parseInt(_base.elements.yearSearchList.value);\n                this.flightSearch.numberOfPeople = parseInt(_base.elements.numberOfPeople.innerHTML);\n                this.reservation = [];\n                for (var i = 0; i < this.flightSearch.numberOfPeople; ++i) {\n                    this.reservation.push({\n                        uzytkownik: null,\n                        miejsce: null,\n                        cena: null,\n                        imie: null,\n                        nazwisko: null,\n                        data_urodzenia: null,\n                        narodowosc: null,\n                        luggage: [0, 0, 0]\n                    });\n                }\n                return true;\n            }\n        }\n    }, {\n        key: 'getDataInfo',\n        value: function getDataInfo(day) {\n            this.date.flight = day.dataset.goto;\n            this.date.minPrice = day.children[1].innerHTML.split('z')[0];\n        }\n    }, {\n        key: 'addLug',\n        value: function addLug(data) {\n            this.reservation[data.personId].luggage[data.luggId]++;\n        }\n    }, {\n        key: 'deleteLug',\n        value: function deleteLug(data) {\n            this.reservation[data.personId].luggage[data.luggId]--;\n        }\n    }, {\n        key: 'fillReservation',\n        value: function fillReservation(data) {\n            for (var i = 0; i < data.length; ++i) {\n                this.reservation[i].imie = data[i].name;\n                this.reservation[i].nazwisko = data[i].surname;\n                this.reservation[i].data_urodzenia = data[i].bday;\n                this.reservation[i].narodowosc = data[i].nation;\n            }\n        }\n    }, {\n        key: 'performReservation',\n        value: function performReservation() {\n            var _this = this;\n\n            var _loop = function _loop(i) {\n                var data = {\n                    uzytkownik: _this.reservation[i].uzytkownik,\n                    miejsce: _this.reservation[i].miejsce,\n                    imie: _this.reservation[i].imie,\n                    nazwisko: _this.reservation[i].nazwisko,\n                    data_urodzenia: _this.reservation[i].data_urodzenia,\n                    narodowosc: _this.reservation[i].narodowosc\n                };\n                fetch(url + '/flights/' + _this.date.flight, {\n                    method: 'POST',\n                    body: JSON.stringify(data),\n                    headers: {\n                        'Content-Type': 'application/json'\n                    }\n                }).then(function (res) {\n                    return res.json();\n                }).then(function (res) {\n                    if (res[0].uc14) {\n                        for (var j = 0; j < _this.reservation[i].luggage.length; ++j) {\n                            if (_this.reservation[i].luggage[j] != 0) {\n                                for (var k = 0; k < _this.reservation[i].luggage[j]; ++k) {\n                                    var data2 = {\n                                        miejsce: data.miejsce,\n                                        typ: j + 1\n                                    };\n                                    fetch(url + '/users/' + data.uzytkownik + '/flights/' + _this.date.flight, {\n                                        method: 'POST',\n                                        body: JSON.stringify(data2),\n                                        headers: {\n                                            'Content-Type': 'application/json' }\n                                    }).then(function (res) {\n                                        return res.json();\n                                    }).then(function (res) {\n                                        if (res.status != 'OK') {\n                                            alert(\"Błąd połączenia z serwerem :( spróbuj poźniej\");\n                                        }\n                                    }).catch(function (error) {\n                                        return console.log(error);\n                                    });\n                                }\n                            }\n                        }\n                    } else {\n                        alert(\"Błąd połączenia z serwerem :( spróbuj poźniej\");\n                    }\n                }).then(function (res) {\n                    if (i == _this.reservation.length - 1) {\n                        _this.clearData();\n                    }\n                }).catch(function (error) {\n                    return console.log(error);\n                });\n            };\n\n            for (var i = 0; i < this.reservation.length; ++i) {\n                _loop(i);\n            }\n        }\n    }, {\n        key: 'clearData',\n        value: function clearData() {\n            this.flightSearch = {\n                origin: null,\n                destination: null,\n                route: null,\n                month: null,\n                year: null,\n                numberOfPeople: null\n            };\n            this.date = {\n                flight: null,\n                minPrice: null\n            };\n            this.reservation = null;\n        }\n    }]);\n\n    return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");

/***/ }),

/***/ "./src/js/models/Seats.js":
/*!********************************!*\
  !*** ./src/js/models/Seats.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearAll = exports.getDestinations = exports.getOrigins = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar url = \"https://server-bd.eu-gb.mybluemix.net\";\n\nvar getOrigins = exports.getOrigins = function getOrigins() {\n    fetch(url + '/flights').then(function (res) {\n        return res.json();\n    }).then(function (res) {\n        return res.forEach(function (el) {\n            _base.elements.originList.insertAdjacentHTML('beforeend', '<li class=\"flight-search__panel__toggler__origins__element\">\\n        <strong class=\"flight-search__panel__toggler__origins__element_name\">' + el.city + '</strong>\\n        <small class=\"flight-search__panel__toggler__origins__element_abrr\">' + el.abbr + '</small>\\n        </li>');\n        });\n    }).catch(function (error) {\n        return console.log(error);\n    });\n};\n\nvar getDestinations = exports.getDestinations = function getDestinations(origin) {\n    fetch(url + '/flights/?city=' + origin).then(function (res) {\n        return res.json();\n    }).then(function (res) {\n        return res.forEach(function (el) {\n            _base.elements.destinationList.insertAdjacentHTML('beforeend', '<li class=\"flight-search__panel__toggler__destinations__element\" data-goto=\"' + el.route + '\">\\n        <strong class=\"flight-search__panel__toggler__destinations__element_name\">' + el.city + '</strong>\\n        <small class=\"flight-search__panel__toggler__destinations__element_abrr\">' + el.abbr + '</small></li>');\n        });\n    }).catch(function (error) {\n        return console.log(error);\n    });\n    _base.elements.listPanel.style.visibility = 'visible';\n};\n\nvar clearAll = exports.clearAll = function clearAll() {\n    _base.elements.reservationContainer.innerHTML = '';\n    _base.elements.reservationContent.style.visibility = 'hidden';\n    _base.elements.searchPageContent.innerHTML = '';\n    _base.elements.searchPageContent.style.visibility = 'hidden';\n    _base.elements.searchDetailsContent.innerHTML = '';\n    _base.elements.searchDetailsContent.style.visibility = 'hidden';\n    _base.elements.seatSubmitbutton.style.visibility = 'hidden';\n    _base.elements.seatsContent.style.visibility = 'hidden';\n    _base.elements.homePageContent.style.visibility = 'visible';\n    _base.elements.allReservationsContent.innerHTML = '';\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");

/***/ }),

/***/ "./src/js/views/seatsView.js":
/*!***********************************!*\
  !*** ./src/js/views/seatsView.js ***!
  \***********************************/
/*! no static exports found */
